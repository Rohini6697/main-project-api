...
from .models import AvailableSlot, MedicalNotes, UserProfile
from .serializers import MedicalNoteserializer, PrescriptionSerializer, RegisterSerializer, SlotSerializer
